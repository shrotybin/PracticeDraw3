...
public class Practice14GetFontMetricsView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float width=(fontMetrics.ascent+fontMetrics.descent)/2;
        canvas.drawText(texts[0], 100, middle-width, paint2);
        canvas.drawText(texts[1], 200, middle-width, paint2);
        canvas.drawText(texts[2], 300, middle-width, paint2);
        canvas.drawText(texts[3], 400, middle-width, paint2);
        canvas.drawText(texts[4], 500, middle-width, paint2);
        canvas.drawText(texts[5], 600, middle-width, paint2);
    }
}
